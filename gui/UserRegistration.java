...
public class UserRegistration extends Decorator implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource().equals(submit)){
            ...
            if(name.getText().isBlank() || password.getText().isBlank() || creditCard.getText().isBlank() || email.getText().isBlank() || !is16Digits(creditCard.getText()) || !isValidEmail(email.getText())){
                name.setText(null);
